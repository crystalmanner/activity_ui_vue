...
module.exports = {
  chainWebpack: config => {
    ...
    config.resolve.alias.set('@freshinup/activity-ui/src', path.resolve(__dirname, 'src'))
    config.resolve.alias.set('activity-ui/storybook', path.resolve(__dirname, '.storybook'))
